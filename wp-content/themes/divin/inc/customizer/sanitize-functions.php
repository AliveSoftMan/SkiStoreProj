<?php
/**
 * Divin Theme Options Sanitization Functions
 *
 * @package Divin
 */
 ...
 */
function divin_sanitize_select( $input, $setting ) {
 ...
 */
function divin_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function divin_sanitize_post( $input ) {
 ...
 */
function divin_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Divin 0.1
 */
function divin_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( is_array( $input ) && in_array( 0, $input ) ) {
            return '0';
        }
        ...
        if ( is_array( $input ) && count( array_intersect( $input, $category_list ) ) == count( $input ) ) {
            return $input;
        }
        else {
            return '';
 ...
 *                    the setting default.
 */
function divin_sanitize_number_range( $number, $setting ) {
