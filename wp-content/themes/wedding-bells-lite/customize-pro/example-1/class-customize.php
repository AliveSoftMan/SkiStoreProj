 ...
 * @access public
 */
final class wedding_bells_lite_Example_1_Customize {
	...
	public function wedding_bells_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'wedding_bells_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new wedding_bells_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
...
wedding_bells_lite_Example_1_Customize::wedding_bells_lite_get_instance();