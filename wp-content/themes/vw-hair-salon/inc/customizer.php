...
function vw_hair_salon_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_hair_salon_email_address',array(
		'default'	=> '',
		'sanitize_callback'	=> 'vw_hair_salon_sanitize_email'
	));	
    ...
    $wp_customize->add_setting('vw_hair_salon_excerpt_settings',array(
        'default' => __('Excerpt','vw-hair-salon'),
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_hair_salon_sanitize_choices'
    ));
	...
	$wp_customize->add_setting( 'vw_hair_salon_metabox_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hair_salon_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Hair_Salon_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hair_salon_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','vw-hair-salon' ),
      'section' => 'vw_hair_salon_responsive_media'
    )));
	...
	$wp_customize->add_setting('vw_hair_salon_copyright_alingment',array(
        'default' => __('center','vw-hair-salon'),
        'sanitize_callback' => 'vw_hair_salon_sanitize_choices'
	));
	$wp_customize->add_control(new VW_Hair_Salon_Image_Radio_Control($wp_customize, 'vw_hair_salon_copyright_alingment', array(
        'type' => 'select',
        'label' => __('Copyright Alignment','vw-hair-salon'),
        'section' => 'vw_hair_salon_footer',
        'settings' => 'vw_hair_salon_copyright_alingment',
        'choices' => array(
